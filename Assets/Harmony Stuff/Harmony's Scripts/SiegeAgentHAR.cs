...
public class SiegeAgentHAR : AgentBasicHAR
{
    ...
    void Update()
    {
        ...
        DecisionManager();
        InRangeBehaviour();
        wpn = GetComponentInChildren<SiegeAgentWeaponHAR>();
        if (wpn == null)
        {
            return;
        }
    ...
    void PerceptionManager()
    {
        ...
        if (eyesPerceived != null)
        {
            ...
            {
                if (eyesP.tag == "Player2" && eyesP.GetComponent<TowerPoorLogicHAR>() == true || eyesP.tag == "Player1" && eyesP.GetComponent<TowerPoorLogicHAR>() == true )
                {
